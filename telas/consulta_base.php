				...
				<div class="container pagina">
		    		...
		    		<div class="form-group">
							<label>Nome do Técnico:</label>
								<input type="text" class="form-control" name="titulo" value="<? echo $result['nm_tecnico'];?>" readonly="true">
								</div>

						<div class="form-group">
							<label>Título:</label>
								<input type="text" class="form-control" name="titulo" value="<?php echo $result['nm_titulo'];?>" readonly="true">
								</div>

		    	        <div class="form-group">
					        <label>Descrição:</label>
					            <textarea class="form-control" name="descricao" rows="5" readonly="true"><?php echo $result['ds_descricao'];?></textarea>									
				         </div>

								<div class="form-group">
									<label>Categoria:</label>
									<input type="text" class="form-control" name="categoria" value="<?php echo $result['nm_categoria'];?>" readonly="true">
								</div>

								<div class="form-group">
									<label>Tipo:</label>
									<input type="text" class="form-control" name="tipo" value="<?php echo $result['nm_tipo'];?>" readonly="true">
								</div>
