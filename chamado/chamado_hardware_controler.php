...
$chamado->__set('nm_acompanhamento',$_POST['tecnico']);
$chamado->__set('dt_agendamento',$_POST['data_agendamento']);
$chamado->__set('ds_urgencia',$_POST['urgencia']);
$chamado->__set('ds_status',$_POST['status']);
$chamado->__set('ds_observacao',$_POST['observacao']);
...
$chamado->__set('ds_problema',$_POST['descricao']);
$chamado->__set('ds_status',$_POST['status']);
$chamado->__set('ds_urgencia',$_POST['prioridade']);
...
$chamado->__set('ds_observacao',$_POST['observacao']);
$chamado->__set('nm_cliente', $_POST['cliente']);
$chamado->__set('dt_fechamento', $_POST['data_fechamento']);
$chamado->__set('ds_acompanhamento',$_POST['acompanhamento']);
